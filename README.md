# ImputingMetabolites
Compare R2 values of different imputation methods on simulated metabolite data. This repository mainly contains the r package described later on. Two additional folders, scripting and markdown, are also included. 
...
The folder markdown contains past markdown documents that I've presented. Since creating them I've updated the general pipeline so those aren't exactly reproducible, but can easily be reproduced using the script/package I've inlcuded. 
